...
//        return;
      ...
      c.DefaultValue = 1;
      c.IsNullable = false;
      t.CreateColumn("Color", new SqlValueType(SqlType.VarChar, 15));
      ...
      c.IsNullable = false;
      t.CreateColumn("Size", new SqlValueType(SqlType.VarChar, 5));
      t.CreateColumn("SizeUnitMeasureCode", new SqlValueType(SqlType.Char, 3));
      t.CreateColumn("WeightUnitMeasureCode", new SqlValueType(SqlType.Char, 3));
      ...
      c.IsNullable = false;
      t.CreateColumn("ProductLine", new SqlValueType(SqlType.Char, 2));
      t.CreateColumn("Class", new SqlValueType(SqlType.Char, 2));
      t.CreateColumn("Style", new SqlValueType(SqlType.Char, 2));
      ...
      SqlTableRef cRef = SqlDml.TableRef(Catalog.Schemas["dbo"].Tables["Person_Contact"], "c");
      SqlTableRef ea = SqlDml.TableRef(Catalog.Schemas["dbo"].Tables["HumanResources_EmployeeAddress"], "ea");
      SqlTableRef a = SqlDml.TableRef(Catalog.Schemas["dbo"].Tables["Person_Address"], "a");
      SqlTableRef sp = SqlDml.TableRef(Catalog.Schemas["dbo"].Tables["Person_StateProvince"], "sp");
      SqlTableRef cr = SqlDml.TableRef(Catalog.Schemas["dbo"].Tables["Person_CountryRegion"], "cr");
