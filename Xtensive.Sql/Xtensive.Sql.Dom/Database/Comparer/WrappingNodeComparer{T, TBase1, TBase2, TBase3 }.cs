...
namespace Xtensive.Sql.Dom.Database.Comparer
{
  ...
  [Serializable]
  public abstract class WrappingNodeComparer<T, TBase1, TBase2, TBase3> : WrappingNodeComparer<T, TBase1, TBase2> 
  {
    /// <summary>
    /// SQL comparer for the third base (wrapped) type.
    /// </summary>
    protected NodeComparerStruct<TBase3> BaseNodeComparer3;
    ...
    protected WrappingNodeComparer(INodeComparerProvider provider)
      : base(provider)
    {
      BaseNodeComparer3 = provider.GetNodeComparer<TBase3>();
    }
  }
}