...
{
  /// <summary>
  /// Base class for any <see cref="INodeComparer{T}"/>s.
  /// </summary>
  /// <typeparam name="T">The schema node type to compare.</typeparam>
  [Serializable]
  public abstract class NodeComparerBase<T> : INodeComparer<T>,
    IDeserializationCallback
  {
    ...
    protected NodeComparerBase(INodeComparerProvider provider)
    {
    ...
    {
      if (provider==null || provider.GetType()==typeof (NodeComparerProvider))
