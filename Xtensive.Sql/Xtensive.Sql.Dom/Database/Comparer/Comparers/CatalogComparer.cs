...
namespace Xtensive.Sql.Dom.Database.Comparer
{
  ...
  internal class CatalogComparer : WrappingNodeComparer<Catalog, Schema> //TODO: PartitionFunction, PartitionSchema
  {
    public override IComparisonResult<Catalog> Compare(Catalog originalNode, Catalog newNode, IEnumerable<ComparisonHintBase> hints)
    {
      ...
      result.DefaultSchema = (SchemaComparisonResult) BaseNodeComparer1.Compare(originalNode==null ? null : originalNode.DefaultSchema, newNode==null ? null : newNode.DefaultSchema, hints);
      hasChanges |= result.DefaultSchema.HasChanges;
      hasChanges |= CompareNestedNodes(originalNode==null ? null : originalNode.Schemas, newNode==null ? null : newNode.Schemas, hints, BaseNodeComparer1, result.Schemas);
