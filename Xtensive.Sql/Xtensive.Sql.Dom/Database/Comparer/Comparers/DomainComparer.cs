...
namespace Xtensive.Sql.Dom.Database.Comparer
{
  ...
  internal class DomainComparer : WrappingNodeComparer<Domain, DomainConstraint, Collation>
  {
    public override IComparisonResult<Domain> Compare(Domain originalNode, Domain newNode, IEnumerable<ComparisonHintBase> hints)
    {
      ...
      result.Collation = (CollationComparisonResult) BaseNodeComparer2.Compare(originalNode==null ? null : originalNode.Collation, newNode==null ? null : newNode.Collation, hints);
      ...
      hasChanges |= CompareNestedNodes(originalNode==null ? null : originalNode.DomainConstraints, newNode==null ? null : newNode.DomainConstraints, hints, BaseNodeComparer1, result.DomainConstraints);
