...
namespace Xtensive.Sql.Dom.Database.Comparer
{
  ...
  internal class SequenceDescriptorComparer : NodeComparerBase<SequenceDescriptor>
  {
    ...
    {
      var result = ComparisonContext.Current.Factory.CreateComparisonResult<SequenceDescriptor, SequenceDescriptorComparisonResult>(originalNode, newNode);
    ...
    public SequenceDescriptorComparer(INodeComparerProvider provider)
      : base(provider)
    {
    }
  }
