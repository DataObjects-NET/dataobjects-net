...
namespace Xtensive.Sql.Common.Mssql.v2005
{
  ...
  public class MssqlServerInfoProvider : IServerInfoProvider
  {
    ...
    private MssqlVersionInfo versionInfo;
    ...
    public virtual TableInfo TableInfo
    {
      get
      {
        ...
        var vi = versionInfo as MssqlVersionInfo;
    ...
    public virtual IndexInfo IndexInfo
    {
      get
      {
        ...
        if (versionInfo.Edition == MssqlEdition.EnterpriseEdition || versionInfo.Edition == MssqlEdition.DeveloperEdition ||
            versionInfo.Edition == MssqlEdition.WorkgroupEdition || versionInfo.Edition == MssqlEdition.StandardEdition)
