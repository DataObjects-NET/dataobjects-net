...
{  
  ...
  public sealed class SortProvider : UnaryProvider
  {
    ...
    {
      header = new RecordSetHeader(Source.Header.TupleDescriptor, Source.Header.Columns, Source.Header.OrderDescriptor.Descriptor, Source.Header.ColumnGroupMappings, SortOrder);
    }
