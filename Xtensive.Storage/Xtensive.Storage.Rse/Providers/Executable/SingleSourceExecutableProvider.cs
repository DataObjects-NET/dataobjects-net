...
namespace Xtensive.Storage.Rse.Providers.Executable
{
  ...
  /// </summary>
  [Serializable]
  public abstract class SingleSourceExecutableProvider: ExecutableProvider
  {
    /// <summary>
    ...
    public SingleSourceExecutableProvider(CompilableProvider origin, Provider source)
      : base(origin, new [] {source})
    {
      Source = source;
    }
  }
