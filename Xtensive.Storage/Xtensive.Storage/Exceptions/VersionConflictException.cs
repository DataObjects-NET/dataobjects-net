...
{
  /// <summary>
  /// Thrown by <see cref="VersionValidator.ValidateVersion(Xtensive.Storage.Key,Xtensive.Storage.VersionInfo,bool)"/>,
  /// <see cref="VersionSet.Validate(Xtensive.Storage.Entity,bool)"/> and similar methods
