...
{
  [Serializable]
  internal class SubqueryToQueryRewriter : ExpressionVisitor
  {
    ...
    {
      var expressionRewriter = new SubqueryToQueryRewriter(parameterOfTuple, applyParameter);
    ...
    private SubqueryToQueryRewriter(Parameter<Tuple> parameterOfTuple, ApplyParameter applyParameter)
    {
