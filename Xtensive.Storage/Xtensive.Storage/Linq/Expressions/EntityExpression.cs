...
namespace Xtensive.Storage.Linq.Expressions
{
    ...
    IEntityExpression
  {
    ...
    public static EntityExpression Create(TypeInfo typeInfo, int offset)
    {
      ...
      var result = new EntityExpression(typeInfo, keyExpression, null, false) {Fields = fields};
      return result;
    }
    ...
    private EntityExpression(TypeInfo entityType, KeyExpression key, ParameterExpression parameterExpression, bool defaultIfEmpty)
