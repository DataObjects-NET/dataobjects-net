...
namespace Xtensive.Storage
{
  ...
  public sealed class CompiledQuery
  {
    ...
    /// <param name="query">The query expression to be compiled.</param>
    /// <returns>A generic delegate of type <see cref="Func{TResult}"/> that represents the compiled query.</returns>
    public static Func<IEnumerable<TElement>> Compile<TElement>(Expression<Func<IQueryable<TElement>>> query)
    {
      throw new NotImplementedException();
    }
    ...
    /// <param name="query">The query expression to be compiled.</param>
    /// <returns>A generic delegate of type <see cref="Func{T0,TResult}"/> that represents the compiled query.</returns>
    public static Func<T0, IEnumerable<TElement>> Compile<T0, TElement>(Expression<Func<T0, IQueryable<TElement>>> query)
    {
      throw new NotImplementedException();
    }
    ...
    /// <param name="query">The query expression to be compiled.</param>
    /// <returns>A generic delegate of type <see cref="Func{T0,TResult}"/> that represents the compiled query.</returns>
    public static Func<T0, T1, IEnumerable<TElement>> Compile<T0, T1, TElement>(Expression<Func<T0, T1, IQueryable<TElement>>> query)
    {
      throw new NotImplementedException();
    }
    ...
    /// <param name="query">The query expression to be compiled.</param>
    /// <returns>A generic delegate of type <see cref="Func{T0,TResult}"/> that represents the compiled query.</returns>
    public static Func<T0, T1, T2, IEnumerable<TElement>> Compile<T0, T1, T2, TElement>(Expression<Func<T0, T1, T2, IQueryable<TElement>>> query)
    {
      throw new NotImplementedException();
    }
    ...
    /// <param name="query">The query expression to be compiled.</param>
    /// <returns>A generic delegate of type <see cref="Func{T0,TResult}"/> that represents the compiled query.</returns>
    public static Func<T0, T1, T2, T3, IEnumerable<TElement>> Compile<T0, T1, T2, T3, TElement>(Expression<Func<T0, T1, T2, T3, IQueryable<TElement>>> query)
    {
      throw new NotImplementedException();
    }
    ...
    /// <param name="query">The query expression to be compiled.</param>
    /// <returns>A generic delegate of type <see cref="Func{T0,TResult}"/> that represents the compiled query.</returns>
    public static Func<T0, T1, T2, T3, T4, IEnumerable<TElement>> Compile<T0, T1, T2, T3, T4, TElement>(Expression<Func<T0, T1, T2, T3, T4, IQueryable<TElement>>> query)
    {
      throw new NotImplementedException();
    }
