...
using Xtensive.Storage.Tests.Storage.NonPersistentCompositeObjectTestModel;

namespace Xtensive.Storage.Tests.Storage.NonPersistentCompositeObjectTestModel
{
  [HierarchyRoot]
