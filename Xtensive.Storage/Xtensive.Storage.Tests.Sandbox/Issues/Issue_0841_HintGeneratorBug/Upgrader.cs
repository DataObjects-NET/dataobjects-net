...
using M1 = Xtensive.Storage.Tests.Issues.Issue_0841_HintGeneratorBug.Model.Version1;
using M2 = Xtensive.Storage.Tests.Issues.Issue_0841_HintGeneratorBug.Model.Version2;

namespace Xtensive.Storage.Tests.Issues.Issue_0841_HintGeneratorBug
{
  [Serializable]
...
#pragma warning disable 612,618
        ...
        hints.Add(new RenameTypeHint(typeof (M1.Base).FullName, typeof (M2.RecycledBase)));
        hints.Add(new RenameTypeHint(typeof (M1.Derived).FullName, typeof (M2.Derived)));
        hints.Add(new CopyFieldHint(typeof (M1.Derived).FullName, "Text", typeof (M2.Derived)));
        return hints;
#pragma warning restore 612,618
      }
    }
