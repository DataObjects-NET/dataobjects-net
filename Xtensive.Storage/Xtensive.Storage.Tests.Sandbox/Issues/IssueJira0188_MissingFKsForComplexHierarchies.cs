...
using Xtensive.Storage.Tests.Issues.IssueJira0188_MissingFKsForComplexHierarchiesModel;

namespace Xtensive.Storage.Tests.Issues.IssueJira0188_MissingFKsForComplexHierarchiesModel
{
...
namespace Xtensive.Storage.Tests.Issues
{
  public class IssueJira0188_MissingFKsForComplexHierarchies : AutoBuildTest
  {
    ...
    {
      var tableName = Domain.NameBuilder.ApplyNamingRules(typeInfo.MappingName);
