...
using Xtensive.Storage.Tests.Issues.IssueJira0222_GroupByBooleanColumnModel;

namespace Xtensive.Storage.Tests.Issues.IssueJira0222_GroupByBooleanColumnModel
{
  [HierarchyRoot]
