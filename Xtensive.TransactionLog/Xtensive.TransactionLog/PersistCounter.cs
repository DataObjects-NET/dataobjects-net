...
namespace Xtensive.TransactionLog
{
  ...
  public sealed class PersistCounter<TKey> : IDisposable, ISynchronizable where TKey : IComparable<TKey>
  {
    ...
    private readonly ValueSerializer<TKey> serializer;
...
// ReSharper restore FunctionNeverReturns
    ...
    public PersistCounter(string name, ILogProvider logProvider, TimeSpan flushTimeout, ValueSerializer<TKey> serializer)
    {
