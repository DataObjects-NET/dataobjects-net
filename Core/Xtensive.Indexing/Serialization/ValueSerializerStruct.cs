...
using S=Xtensive.Indexing.Serialization;

namespace Xtensive.Indexing.Serialization
{
  /// <summary>
  /// A struct providing faster access for key 
  /// <see cref="Serialization.ValueSerializer{T}"/> delegates.
  /// </summary>
  ...
  public struct ValueSerializerStruct<T> : ISerializable
  {
    ...
    /// <see cref="Serialization.ValueSerializer{T}.Default"/> hasher.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion of <see cref="Serialization.ValueSerializer{T}"/> 
    ...
    /// </summary>
    /// <param name="valueSerializer"><see cref="Serialization.ValueSerializer{T}"/> 
