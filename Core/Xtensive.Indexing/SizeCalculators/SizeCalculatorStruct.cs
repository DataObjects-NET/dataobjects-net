...
{
  /// <summary>
  /// A struct providing faster access for key size calculator delegates.
  /// </summary>
  ...
  {
    /// <summary>
    /// Gets <see cref="SizeCalculatorStruct{T}"/> for <see cref="SizeCalculators.SizeCalculator{T}.Default"/> hasher.
    /// </summary>
    ...
    /// <summary>
    /// Implicit conversion of <see cref="SizeCalculators.SizeCalculator{T}"/> to <see cref="SizeCalculatorStruct{T}"/>.
    /// </summary>
