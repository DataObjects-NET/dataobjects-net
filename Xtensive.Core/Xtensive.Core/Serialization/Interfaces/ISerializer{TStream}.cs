...
namespace Xtensive.Core.Serialization
{
  ...
  public interface ISerializer<TStream>
  {
    /// <summary>
    ...
    void Serialize(TStream stream, object source, object origin);
    ...
    /// <param name="stream">The stream to serialize to.</param>
    /// <param name="source">The object graph to serialize.</param>
    void Serialize(TStream stream, object source);

    /// <summary>
    /// Deserializes the changes stored by <see cref="Serialize(TStream,object,object)"/>
    ...
    object Deserialize(TStream stream, object origin);
