    ...
    ICloneable
  {
    ...
    public void Insert(int index, T item)
    {
      ...
      if (bufferIndex==tailPos)
        ...
        throw Exceptions.InternalError("Deque.Insert: Wrong buffer index detected.", Log.Instance);
      }
    }
    ...
    public void RemoveAt(int index)
    {
      ...
      if (tailPos - bufferIndex==1)
        ...
        throw Exceptions.InternalError("Deque.RemoveAt: Wrong buffer index detected.", Log.Instance);
      }
    }
