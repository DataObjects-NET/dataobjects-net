  ...
  public sealed class ImplementAutoPropertyReplacementAspect : LaosMethodLevelAspect
  {
    ...
    public override bool  CompileTimeValidate(MethodBase method)
    {
      ...
      if (accessorInfo == null) {
        ErrorLog.Write(SeverityType.Error, Strings.AspectExCanBeAppliedToPropertyAccessorsOnly,
      ...
      if (AttributeHelper.GetAttribute<CompilerGeneratedAttribute>(method, false) == null) {
        ErrorLog.Write(SeverityType.Error, Strings.AspectExCanBeAppliedToAutoGeneratedPropertiesOnly,
          GetType().GetShortName(), 
          method.DeclaringType.GetShortName());
        return false;
      }
