  ...
  public sealed class ImplementAutoPropertyReplacementAspect : LaosMethodLevelAspect
  {
    ...
    public override bool  CompileTimeValidate(MethodBase method)
    {
      ...
      if (accessorInfo == null) {
        AspectsMessageSource.Instance.Write(SeverityType.Error, "AspectExCanBeAppliedToPropertyAccessorsOnly",
      ...
      if (AttributeHelper.GetAttribute<CompilerGeneratedAttribute>(method, false) == null) {
        AspectsMessageSource.Instance.Write(SeverityType.Error, "AspectExCanBeAppliedToAutoGeneratedPropertiesOnly",
          new object[] { GetType().Name, method.DeclaringType.FullName });
        return false;
      }
