...
namespace Xtensive.Core.Aspects.Resources {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Error in type {1}. {0} attribute requires no method with signature {4} {1}({2})..
        /// </summary>
        internal static string AspectExMethodExists {
            get {
                return ResourceManager.GetString("AspectExMethodExists", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Error in type {1}. {0} attribute requires {4} {2}({3}) method to be {5}..
        /// </summary>
        internal static string AspectExMethodMustBeX {
            get {
                return ResourceManager.GetString("AspectExMethodMustBeX", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string AspectExNoBaseTypeOrInterface {
            get {
                return ResourceManager.GetString("AspectExNoBaseTypeOrInterface", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Error in type {1}. {0} attribute requires {1} to have {2} field..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to non-virtual.
        /// </summary>
        internal static string NonVirtual {
            get {
                return ResourceManager.GetString("NonVirtual", resourceCulture);
            }
        }
