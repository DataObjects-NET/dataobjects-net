...
namespace Xtensive.PluginManager
{
  ...
  public class RemoteAssemblyInspector: MarshalByRefObject, IAssemblyInspector
  {
    ...
    public void FindTypes(string file, Type baseType, Type attributeType)
    {
      ...
      Assembly assembly = LoadFrom(file);
      if (assembly != null) {
        FindTypes(assembly, baseType, attributeType);
      }
      OnInspectionComplete(file);
    }

    private void FindTypes(Assembly assembly, Type baseType, Type attributeType)
    {
    ...
    public void FindTypes(AssemblyName assemblyName, Type baseType, Type attributeType)
    {
      ...
      OnInspectionStart(assembly.Location);
      FindTypes(assembly, baseType, attributeType);
      OnInspectionComplete(assembly.Location);
    }
    ...
    {
      try {
        return Assembly.ReflectionOnlyLoad(assemblyName.ToString());
      }
