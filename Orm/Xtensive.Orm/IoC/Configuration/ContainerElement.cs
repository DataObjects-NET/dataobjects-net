...
namespace Xtensive.IoC.Configuration
{
  ...
  public class ContainerElement : ConfigurationCollectionElementBase
  {
    ...
    public string Name
    {
      get => (string) this[NameElementName];
    ...
    public string Type
    {
      get => (string) this[TypeElementName];
    ...
    {
      get => (string) this[ParentElementName];
    ...
    public ConfigurationCollection<ServiceRegistrationElement> Explicit
      => (ConfigurationCollection<ServiceRegistrationElement>) base[ExplicitElementName];
    ...
    public ConfigurationCollection<TypeRegistrationElement> Auto
      => (ConfigurationCollection<TypeRegistrationElement>) base[AutoElementName];
  }
}