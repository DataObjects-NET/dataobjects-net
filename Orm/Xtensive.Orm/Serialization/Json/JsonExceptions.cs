...
namespace Xtensive.Serialization.Json
{
  ...
  internal static class JsonExceptions
  {
    ...
    {
      return new JsonException(string.Format(WrongStructureExceptionTemplate, details));
    }
    ...
    {
      return new JsonException($"Can't resolve '{assemblyQualifiedName}' type name into System.Type instance.");
    }
  }
}
