...
namespace Xtensive.Sql.Drivers.SqlServer.v09
{
  internal class Translator : SqlTranslator
  {
    ...
    /// <inheritdoc/>
    public override string Translate(SqlTrimType type) => string.Empty;
