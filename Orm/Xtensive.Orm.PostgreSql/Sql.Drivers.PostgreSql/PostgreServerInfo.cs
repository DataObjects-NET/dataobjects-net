...
namespace Xtensive.Sql.Drivers.PostgreSql
{
  ...
  internal sealed class PostgreServerInfo
  {
    ...
    /// </summary>
    public bool InfinityAliasForDatesEnabled { get; }
    ...
    /// </summary>
    public bool LegacyTimestampBehavior { get; }
    ...
    public PostgreServerInfo(bool infinityAliasForDatesEnabled, bool legacyTimestampBehavior, TimeZoneInfo defaultTimeZone)
    {
      InfinityAliasForDatesEnabled = infinityAliasForDatesEnabled;
      LegacyTimestampBehavior = legacyTimestampBehavior;
