    ...
    public override void Translate(IOutput output, SqlNodeType type)
    {
      switch (type) {
        ...
        case SqlNodeType.BitAnd:
          _ = output.Append("BIN_AND");
          break;
        case SqlNodeType.BitOr:
          _ = output.Append("BIN_OR");
          break;
        case SqlNodeType.BitXor:
          _ = output.Append("BIN_XOR");
          break;
        default:
    ...
    public override void Translate(IOutput output, SqlFunctionType type)
    {
      switch (type) {
        case SqlFunctionType.CharLength:
          _ = output.Append("CHAR_LENGTH");
          break;
        case SqlFunctionType.BinaryLength:
          _ = output.Append("OCTET_LENGTH");
          break;
        ...
        case SqlFunctionType.Log10:
          _ = output.Append("LOG10");
          break;
        case SqlFunctionType.Ceiling:
          _ = output.Append("CEIL");
          break;
        case SqlFunctionType.PadLeft:
          _ = output.Append("LPAD");
          break;
        case SqlFunctionType.PadRight:
          _ = output.Append("RPAD");
          break;
        ...
        case SqlFunctionType.SessionUser:
          base.Translate(output, SqlFunctionType.CurrentUser);
          break;
        ...
        case SqlFunctionType.IntervalAbs:
          base.Translate(output, SqlFunctionType.Abs);
          break;
        default:
          base.Translate(output, type);
          break;
    ...
    public override void Translate(IOutput output, SqlDateTimePart dateTimePart)
    {
      switch (dateTimePart) {
        case SqlDateTimePart.DayOfYear:
          _ = output.Append("YEARDAY");
          break;
        case SqlDateTimePart.DayOfWeek:
          _ = output.Append("WEEKDAY");
          break;
        default:
