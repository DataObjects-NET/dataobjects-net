  ...
  internal class Translator : SqlTranslator
  {
    ...
    public override string Translate(SqlFunctionType functionType)
    {
      return functionType switch {
        ...
        SqlFunctionType.CurrentDate => "DATE()",
        SqlFunctionType.BinaryLength => "LENGTH",
        SqlFunctionType.LastAutoGeneratedId => "LAST_INSERT_ROWID()",
        SqlFunctionType.DateTimeAddMonths => "DATE",
        SqlFunctionType.DateTimeConstruct => "DATETIME",
    ...
    public override string Translate(SqlDateTimePart dateTimePart)
    {
      return dateTimePart switch {
        SqlDateTimePart.Year => "'%Y'",
        SqlDateTimePart.Month => "'%m'",
        SqlDateTimePart.Day => "'%d'",
        SqlDateTimePart.DayOfWeek => "'%w'",
        SqlDateTimePart.DayOfYear => "'%j'",
        SqlDateTimePart.Hour => "'%H'",
        SqlDateTimePart.Minute => "'%M'",
        SqlDateTimePart.Second => "'%S'",
        _ => throw SqlHelper.NotSupported(dateTimePart.ToString()),
      };
    }

    /// <inheritdoc/>
    public override string Translate(SqlIntervalPart intervalPart) => throw SqlHelper.NotSupported(intervalPart.ToString());
    ...
    {
      return type switch {
        SqlNodeType.DateTimePlusInterval or
          SqlNodeType.DateTimeOffsetPlusInterval => "+",
        SqlNodeType.DateTimeMinusInterval or
          SqlNodeType.DateTimeMinusDateTime or
          SqlNodeType.DateTimeOffsetMinusInterval or
          SqlNodeType.DateTimeOffsetMinusDateTimeOffset => "-",
