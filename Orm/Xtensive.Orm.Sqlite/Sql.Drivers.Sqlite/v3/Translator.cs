    ...
    internal class Translator : SqlTranslator
    {
        ...
        public override string Translate(SqlCompilerContext context, SqlCreateIndex node, CreateIndexSection section)
        {
            ...
            case CreateIndexSection.Entry:
                return string.Format("CREATE {0} INDEX {1} ON {2} "
                                     ...
                                     , QuoteIdentifier(index.DataTable.Name));
        ...
        public override string Translate(SqlCompilerContext context, SqlExtract extract, ExtractSection section)
        {
            ...
            case ExtractSection.From:
                if (extract.DateTimePart == SqlDateTimePart.Year) return "'%Y'";
                else if (extract.DateTimePart == SqlDateTimePart.Month) return "'%m'";
                else if (extract.DateTimePart == SqlDateTimePart.Day) return "'%d'";
                else if (extract.DateTimePart == SqlDateTimePart.DayOfWeek) return "'%w'";
                else if (extract.DateTimePart == SqlDateTimePart.Hour) return "'%H'";
                else if (extract.DateTimePart == SqlDateTimePart.Minute) return "'%M'";
                else if (extract.DateTimePart == SqlDateTimePart.Second) return "'%s'";
                else if (extract.DateTimePart == SqlDateTimePart.Millisecond) return "'%f'";
                else {
