...
namespace Xtensive.Orm.Tests.Upgrade.CustomTypeIdModel11
{
  ...
  namespace Database2
  {
    ...
    public class Upgrader : UpgradeHandler
    {
      public override bool IsEnabled => UpgradeContext.Configuration.UpgradeMode == DomainUpgradeMode.Recreate;
...
namespace Xtensive.Orm.Tests.Upgrade
{
  ...
  public class CustomTypeIdMap : AutoBuildTest
  {
    ...
    public void RecreateTest()
    {
      ...
      _ = Assert.Throws<DomainBuilderException>(() => BuildDomain(configuration));
    ...
    public void LegacySkipMultiDatabaseTest()
    {
      ...
      firstConfiguration.Databases.Add(new DatabaseConfiguration(DOTests2Db));
      ...
      secondConfiguration.Databases.Add(new DatabaseConfiguration(DOTests1Db));
      secondConfiguration.Databases.Add(new DatabaseConfiguration(DOTests2Db));
      secondConfiguration.Databases.Add(new DatabaseConfiguration(DOTests3Db));
      secondConfiguration.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database2.Child).Assembly, typeof(multyDatabaseModel.Database2.Child).Namespace, DOTests1Db, dbo));
      secondConfiguration.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database1.Book).Assembly, typeof(multyDatabaseModel.Database1.Book).Namespace, DOTests2Db, dbo));
      secondConfiguration.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database3.Car).Assembly, typeof(multyDatabaseModel.Database3.Car).Namespace, DOTests3Db, dbo));
    ...
    public void UserTypeIdLimits()
    {
      ...
      rightConfiguration.Databases.Add(new DatabaseConfiguration(DOTests1Db) { MinTypeId = 200, MaxTypeId = 299 });
      rightConfiguration.Databases.Add(new DatabaseConfiguration(DOTests2Db) { MinTypeId = 100, MaxTypeId = 199 });
      rightConfiguration.Databases.Add(new DatabaseConfiguration(DOTests3Db) { MinTypeId = 300, MaxTypeId = 399 });
      rightConfiguration.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database2.Child).Assembly, typeof(multyDatabaseModel.Database2.Child).Namespace, DOTests1Db, dbo));
      rightConfiguration.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database1.Book).Assembly, typeof(multyDatabaseModel.Database1.Book).Namespace, DOTests2Db, dbo));
      rightConfiguration.MappingRules.Add(
      ...
      wrongConfiguration1.Databases.Add(new DatabaseConfiguration(DOTests1Db) { MinTypeId = 500, MaxTypeId = 600 });
      wrongConfiguration1.Databases.Add(new DatabaseConfiguration(DOTests2Db) { MinTypeId = 100, MaxTypeId = 199 });
      wrongConfiguration1.Databases.Add(new DatabaseConfiguration(DOTests3Db) { MinTypeId = 300, MaxTypeId = 399 });
      wrongConfiguration1.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database2.Child).Assembly, typeof(multyDatabaseModel.Database2.Child).Namespace, DOTests1Db, dbo));
      wrongConfiguration1.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database1.Book).Assembly, typeof(multyDatabaseModel.Database1.Book).Namespace, DOTests2Db, dbo));
      wrongConfiguration1.MappingRules.Add(
      ...
      wrongConfiguration2.Databases.Add(new DatabaseConfiguration(DOTests1Db) { MinTypeId = 200, MaxTypeId = 299 });
      wrongConfiguration2.Databases.Add(new DatabaseConfiguration(DOTests2Db) { MinTypeId = 500, MaxTypeId = 600 });
      wrongConfiguration2.Databases.Add(new DatabaseConfiguration(DOTests3Db) { MinTypeId = 300, MaxTypeId = 399 });
      wrongConfiguration2.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database2.Child).Assembly, typeof(multyDatabaseModel.Database2.Child).Namespace, DOTests1Db, dbo));
      wrongConfiguration2.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database1.Book).Assembly, typeof(multyDatabaseModel.Database1.Book).Namespace, DOTests2Db, dbo));
      wrongConfiguration2.MappingRules.Add(
      ...
      wrongConfiguration3.Databases.Add(new DatabaseConfiguration(DOTests1Db) { MinTypeId = 200, MaxTypeId = 299 });
      wrongConfiguration3.Databases.Add(new DatabaseConfiguration(DOTests2Db) { MinTypeId = 100, MaxTypeId = 199 });
      wrongConfiguration3.Databases.Add(new DatabaseConfiguration(DOTests3Db) { MinTypeId = 500, MaxTypeId = 600 });
      wrongConfiguration3.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database2.Child).Assembly, typeof(multyDatabaseModel.Database2.Child).Namespace, DOTests1Db, dbo));
      wrongConfiguration3.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database1.Book).Assembly, typeof(multyDatabaseModel.Database1.Book).Namespace, DOTests2Db, dbo));
      wrongConfiguration3.MappingRules.Add(
        new MappingRule(typeof(multyDatabaseModel.Database3.Car).Assembly, typeof(multyDatabaseModel.Database3.Car).Namespace, DOTests3Db, dbo));
      _ = Assert.Throws<DomainBuilderException>(() => BuildDomain(wrongConfiguration3));
    }
    ...
    private void BuildInitialDomains()
    {
      ...
      secondConfig.Databases.Add(new DatabaseConfiguration(DOTests1Db));
      ...
      thirdConfig.Databases.Add(new DatabaseConfiguration(DOTests3Db));
    ...
    private DomainConfiguration BuildConfiguration(Type baseNamespaceType, DomainUpgradeMode mode) =>
      BuildConfiguration(baseNamespaceType, null, mode);
