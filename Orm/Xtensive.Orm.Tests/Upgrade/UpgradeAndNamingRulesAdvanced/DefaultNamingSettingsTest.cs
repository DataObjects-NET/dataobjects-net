...
{
  public sealed class DefaultNamingSettingsTest : TestBase
  {
    protected override NamingConvention CreateNamingConvention()
    {
      var namingConversion = new NamingConvention {
        LetterCasePolicy = LetterCasePolicy.Default,
        NamespacePolicy = NamespacePolicy.Default,
        NamingRules = NamingRules.Default
      };
