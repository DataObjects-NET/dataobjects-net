...
namespace Xtensive.Orm.Tests.Upgrade.TableMovesToAnotherHierarchy
{
  ...
  public sealed class RenamedColumnInNewHierarchytest : TestBase
  {
    protected override void CheckSingleTableComparisonResult(SchemaComparisonResult comparisonResult)
    {
      ...
      var unsafeActions = comparisonResult.UnsafeActions;
    ...
    protected override void CheckClassTableComparisonResult(SchemaComparisonResult comparisonResult)
    {
      ...
      var dataActions = unsafeActions.OfType<DataAction>().ToList(2);
...
namespace Xtensive.Orm.Tests.Upgrade.TableMovesToAnotherHierarchy.RenamedColumnInNewHierarchyTestModel
{
  public static class TestHelper
  {
    public static void PopulateSingleTable(Session session)
    {
      _ = new Before.SingleTableLeaf(session, "Leaf", "Leaf") {
        LeafValue = "Leaf",
        OldNameFieldRoot = "OldNameFieldRoot",
        OldNameFieldLeaf = "OldNameFieldLeaf"
      };
    ...
    public static void PopulateClassTable(Session session)
    {
      ...
      _ = new Before.ClassTableRoot(session, "Root", "Root") { OldNameFieldRoot = "OldNameFieldRoot" };
    }
  ...
  namespace Before
  {
    ...
    public class ClassTableRoot : Entity
    {
      ...
      [Field(Length = 50)]
      public string OldNameFieldRoot { get; set; }
    ...
    public class ClassTableLeaf : ClassTableRoot
    {
      ...
      [Field(Length = 50)]
      public string OldNameFieldLeaf { get; set; }
  ...
  namespace After
  {
    ...
    public class ClassTableLeaf : ClassTableNewRoot
    {
      ...
      [Field(Length = 50)]
      public string NewNameFieldLeaf { get; set; }
    ...
    public abstract class ClassTableBase : Entity
    {
      ...
      [Field(Length = 50)]
      public string NewNameFieldRoot { get; set; }
    ...
    public class ClassTableUpgradeHandler : UpgradeHandler
    {
      ...
      protected override void AddUpgradeHints(Collections.ISet<UpgradeHint> hints)
      {
        ...
        _ = hints.Add(new RenameFieldHint(rootType, "OldNameFieldRoot", "NewNameFieldRoot"));
        _ = hints.Add(new RenameFieldHint(leafType, "OldNameFieldLeaf", "NewNameFieldLeaf"));
      }
    }
