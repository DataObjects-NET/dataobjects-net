...
{
  /// <summary>
  /// Test for domain which includes several schemes
  /// </summary>
  public abstract class MultischemaDomainTest : SkipBuildingTestBase
  {
    ...
    protected override DomainConfiguration BuildConfiguration()
    {
      ...
      configuration.MappingRules.Map(typeof(User).Assembly, typeof(User).Namespace).ToSchema(Schema1);
      configuration.MappingRules.Map(typeof(Laptop).Assembly, typeof(Laptop).Namespace).ToSchema(Schema2);
  ...
  public sealed class MultischemaDomainWithoutForeignKeysTest : MultischemaDomainTest
  {
  ...
  public sealed class MultischemaDomainHierarchyForeignKeysTest : MultischemaDomainTest
  {
    protected override ForeignKeyMode GetForeignKeyMode()
    {
  ...
  public sealed class MultischemaDomainReferenceForeignKeysTest : MultischemaDomainTest
  {
    protected override ForeignKeyMode GetForeignKeyMode()
    {
  ...
  public sealed class MultischemaDomainAllForeignKeysTest : MultischemaDomainTest
  {
    protected override ForeignKeyMode GetForeignKeyMode()
    {
