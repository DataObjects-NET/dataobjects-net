  ...
  public class MultischemaTest : SimpleSchemaTest
  {
    ...
    protected override string PopulateSystemTablesScript()
    {
      return
        ...
        $"INSERT INTO [{DefaultSchema}].[Metadata.Assembly] ([Name], [Version] ) VALUES (N'Xtensive.Orm', N'{typeof(Domain).Assembly.GetName().Version.ToString(4)}');" +
        $"INSERT INTO [{DefaultSchema}].[Metadata.Assembly] ([Name], [Version] ) VALUES (N'Xtensive.Orm.Tests', N'{typeof(MultischemaTest).Assembly.GetName().Version.ToString(4)}');" +
