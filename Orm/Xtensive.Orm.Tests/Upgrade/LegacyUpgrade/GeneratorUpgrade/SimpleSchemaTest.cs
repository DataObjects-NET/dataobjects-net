  ...
  public class SimpleSchemaTest
  {
    ...
    protected virtual string PopulateSystemTablesScript()
    {
      return "DELETE FROM [dbo].[Metadata.Type];" +
        ...
        $"INSERT INTO [dbo].[Metadata.Assembly] ([Name], [Version] ) VALUES (N'Xtensive.Orm', N'{typeof(Domain).Assembly.GetName().Version.ToString(4)}');" +
        $"INSERT INTO [dbo].[Metadata.Assembly] ([Name], [Version] ) VALUES (N'Xtensive.Orm.Tests', N'{typeof(SimpleSchemaTest).Assembly.GetName().Version.ToString(4)}');" +
