...
using Xtensive.Orm.Tests.Sandbox.IssueJira0179_NullableBooleanFieldsQueryModel;

namespace Xtensive.Orm.Tests.Sandbox.IssueJira0179_NullableBooleanFieldsQueryModel
{
  [HierarchyRoot]
...
namespace Xtensive.Orm.Tests.Sandbox
{
