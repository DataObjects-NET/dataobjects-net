...
{
  public class InstanceFieldTestRunner : TestRunnerBase
  {
    private readonly static string thisClassName = nameof(InstanceFieldTestRunner);

    private ParameterContainer field1;
    private ParameterContainer field2;
    private ParameterContainer field3;

    protected override string ThisClassName => thisClassName;

    public void GeneralAccessScalar(Session session)
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.GeneralAccessScalar);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.GeneralAccessSequence);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.GeneralAccessOrderedSequence);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.AccessFromNestedMethodScalar);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.AccessFromNestedMethodSequence);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.AccessFromNestedMethodOrderedSequence);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.AccessFromLocalFuncScalar);
...
#pragma warning restore IDE0039 // Use local function
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.AccessFromLocalFuncSequence);
...
#pragma warning restore IDE0039 // Use local function
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.AccessFromLocalFuncOrderedSequence);
...
#pragma warning restore IDE0039 // Use local function
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.CacheAcrossMethodsScalar);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.CacheAcrossMethodsSequence);
    ...
    {
      var thisMethodName = nameof(InstanceFieldTestRunner.CacheAcrossMethodsOrderedSequence);
