...
{
  public class InstancePropertyTestRunner : TestRunnerBase
  {
    private readonly static string thisClassName = nameof(InstancePropertyTestRunner);

    private ParameterContainer Prop1 { get; set; }
    private ParameterContainer Prop2 { get; set; }
    private ParameterContainer Prop3 { get; set; }

    protected override string ThisClassName => thisClassName;

    public void GeneralAccessScalar(Session session)
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.GeneralAccessScalar);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.GeneralAccessSequence);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.GeneralAccessOrderedSequence);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.AccessFromNestedMethodScalar);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.AccessFromNestedMethodSequence);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.AccessFromNestedMethodOrderedSequence);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.AccessFromLocalFuncScalar);
...
#pragma warning restore IDE0039 // Use local function
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.AccessFromLocalFuncSequence);
...
#pragma warning restore IDE0039 // Use local function
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.AccessFromLocalFuncOrderedSequence);
...
#pragma warning restore IDE0039 // Use local function
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.CacheAcrossMethodsScalar);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.CacheAcrossMethodsSequence);
    ...
    {
      var thisMethodName = nameof(InstancePropertyTestRunner.CacheAcrossMethodsOrderedSequence);
