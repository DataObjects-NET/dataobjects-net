...
using Xtensive.Orm.Tests.Storage.ReferentialIntegrity.ClientProfileLike.ReferenceFromStructuresTestModel;

namespace Xtensive.Orm.Tests.Storage.ReferentialIntegrity.ClientProfileLike.ReferenceFromStructuresTestModel
{
...
namespace Xtensive.Orm.Tests.Storage.ReferentialIntegrity.ClientProfileLike
{
  ...
  {
    private int EntitiesWithStructureCount;
