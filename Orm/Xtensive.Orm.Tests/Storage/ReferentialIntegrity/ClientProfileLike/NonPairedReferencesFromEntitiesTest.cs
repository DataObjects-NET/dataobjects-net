...
namespace Xtensive.Orm.Tests.Storage.ReferentialIntegrity.ClientProfileLike.NonPairedReferencesFromEntitiesModel
{
  [HierarchyRoot]
  ...
  public class NonPairedReferencesFromEntitiesTest : AutoBuildTest
  {
    ...
    public void ChangeStoredReferenceTest()
    {
      ...
      using (var transaction = populateSession.OpenTransaction()) {
        ...
        referencingEntity.EntityField = referencedEntity;
        referencedEntityKey = referencedEntity.Key;
    ...
    protected override DomainConfiguration BuildConfiguration()
    {
      ...
      configuration.Types.RegisterCaching(typeof (EntityWithManyReferences).Assembly, typeof (EntityWithManyReferences).Namespace);
