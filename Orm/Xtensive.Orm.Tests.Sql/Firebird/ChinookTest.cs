...
namespace Xtensive.Orm.Tests.Sql.Firebird
{
  ...
  public class ChinookTest : ChinookTestBase
  {
    ...
    public void Test008()
    {
      var nativeSql = "SELECT \"i\".\"InvoiceId\", round(\"i\".\"Commission\" * 12, 1) \"Rounded\" " +
                      "FROM \"Invoice\" \"i\" " +
    ...
    public void Test014()
    {
      var nativeSql = "SELECT DATEADD(MONTH, -15, CURRENT_TIMESTAMP) AS \"Days\" FROM RDB$DATABASE";
    ...
    public void Test015()
    {
      var nativeSql = "SELECT DATEADD(MONTH, 1 + 1, CURRENT_TIMESTAMP) AS \"Days\" FROM RDB$DATABASE";
    ...
    public void Test016()
    {
      var nativeSql = "SELECT EXTRACT(DAY FROM CURRENT_TIMESTAMP) AS \"DayOfMonth\" FROM RDB$DATABASE";
    ...
    public void Test017()
    {
      var nativeSql = "SELECT EXTRACT(MONTH FROM CURRENT_TIMESTAMP) AS \"Month\" FROM RDB$DATABASE";
    ...
    public void Test018()
    {
      var nativeSql = "select EXTRACT(YEAR FROM CURRENT_TIMESTAMP) AS \"Year\" FROM RDB$DATABASE";
    ...
    public void Test019()
    {
      var nativeSql = "SELECT EXTRACT(HOUR FROM CURRENT_TIMESTAMP) AS \"Hour\" FROM RDB$DATABASE";
    ...
    public void Test020()
    {
      var nativeSql = "SELECT EXTRACT(MINUTE FROM CURRENT_TIMESTAMP) AS \"Minutes\" FROM RDB$DATABASE";
    ...
    public void Test021()
    {
      var nativeSql = "SELECT EXTRACT(SECOND FROM CURRENT_TIMESTAMP) AS \"Seconds\" FROM RDB$DATABASE";
    ...
    public void Test022()
    {
      var nativeSql = "SELECT EXTRACT(MILLISECOND FROM CURRENT_TIMESTAMP) AS \"Milliseconds\" FROM RDB$DATABASE";
    ...
    public void Test023()
    {
      var nativeSql = "SELECT cast('2011-11-16' as date) AS \"BirthDay\" FROM RDB$DATABASE";
    ...
    public void Test037()
    {
      var nativeSql = "SELECT * FROM \"Customer\" \"c\" ROWS 1 TO 10";
    ...
    public void Test052()
    {
      var nativeSql =
        "SELECT \"a\".\"f\" " +
        "FROM (" +
               "SELECT 1 as \"f\" FROM RDB$DATABASE " +
               "UNION SELECT 2 FROM RDB$DATABASE " +
               "UNION SELECT 3 FROM RDB$DATABASE " +
               "UNION SELECT 4 FROM RDB$DATABASE) \"a\"";
