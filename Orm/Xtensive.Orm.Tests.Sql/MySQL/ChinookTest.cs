...
namespace Xtensive.Orm.Tests.Sql.MySQL
{
  ...
  public class ChinookTest : ChinookTestBase
  {
    ...
    public void Test014()
    {
      var nativeSql = "SELECT TIMESTAMPADD(MONTH, (-15), CURRENT_TIMESTAMP) AS `Days`";
    ...
    public void Test015()
    {
      var nativeSql = "SELECT TIMESTAMPADD(MONTH, (1 + 1), CURRENT_TIMESTAMP) AS `Days`";
    ...
    public void Test022()
    {
      var nativeSql = "SELECT ( EXTRACT(MICROSECOND FROM CURRENT_TIMESTAMP) % 1000) AS `Milliseconds`";
