...
namespace Xtensive.Orm.Tests.Sql.Sqlite
{
  [TestFixture]
  [Explicit]
  public class DateTimeIntervalTests : Northwind
  {
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.DateTimeConstruct(2005, 5, 5));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.DateTimeMinusDateTime(new DateTime(2005, 5, 5, 5, 5, 5), new DateTime(2005, 5, 6, 6, 6, 6)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.DateTimeMinusInterval(new DateTime(2005, 5, 5, 5, 5, 5, 5), new TimeSpan(4, 4, 4, 4, 4)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.DateTimeTruncate(new DateTime(2005, 1, 1, 1, 1, 1, 1)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.Year, new DateTime(2006, 5, 4)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.Day, new DateTime(2006, 5, 4)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.Hour, new DateTime(2006, 5, 4, 3, 2, 1, 333)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.Minute, new DateTime(2006, 5, 4, 3, 2, 1, 333)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.Second, new DateTime(2006, 5, 4, 3, 2, 1, 333)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.Millisecond, new DateTime(2006, 5, 4, 3, 2, 1, 333)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.DayOfWeek, new DateTime(2009, 3, 2)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlDateTimePart.DayOfYear, new DateTime(2005, 2, 2)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.IntervalConstruct(500000000));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlIntervalPart.Day, new TimeSpan(6, 5, 4, 3, 2)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlIntervalPart.Hour, new TimeSpan(6, 5, 4, 3, 2)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlIntervalPart.Minute, new TimeSpan(6, 5, 4, 3, 2)));
      select.Columns.Add(4);
    }
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlIntervalPart.Second, new TimeSpan(6, 5, 4, 3, 2)));
      select.Columns.Add(3);
    }
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.Extract(SqlIntervalPart.Millisecond, new TimeSpan(6, 5, 4, 3, 2)));
      select.Columns.Add(2);
    }
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.IntervalToMilliseconds(new TimeSpan(0, 0, 8, 5, 5)));
    ...
    {
      var select = SqlDml.Select();
      select.Columns.Add(SqlDml.IntervalAbs(new TimeSpan(10, 0, 0, 0).Negate()));
