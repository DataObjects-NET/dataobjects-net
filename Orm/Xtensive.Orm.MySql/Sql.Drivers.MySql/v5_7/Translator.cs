...
namespace Xtensive.Sql.Drivers.MySql.v5_7
{
  internal class Translator : SqlTranslator
  {
    ...
    public override void Translate(IOutput output, SqlFunctionType type)
    {
      switch (type) {
        case SqlFunctionType.LastAutoGeneratedId:
          _ = output.Append("LAST_INSERT_ID()");
          break;
        case SqlFunctionType.SystemUser:
          _ = output.Append("SYSTEM_USER()");
          break;
        ...
        case SqlFunctionType.SessionUser:
          _ = output.Append("SESSION_USER()");
          break;
        //datetime/timespan
        case SqlFunctionType.DateTimeTruncate:
          _ = output.Append("DATE");
          break;
        case SqlFunctionType.CurrentDate:
          _ = output.Append("CURDATE()");
          break;
        ...
        case SqlFunctionType.Lower:
          _ = output.Append("LCASE");
          break;
        case SqlFunctionType.Position:
          _ = output.Append("LOCATE");
          break;
        case SqlFunctionType.Upper:
          _ = output.Append("UCASE");
          break;
        case SqlFunctionType.Concat:
          _ = output.Append("CONCAT()");
          break;
        //math
    ...
    public override void Translate(SqlCompilerContext context, SqlCast node, NodeSection section)
    {
      ...
      if (sqlType == SqlType.Binary ||
        ...
        _ = section switch {
          ...
          NodeSection.Exit => output.Append("AS ").Append(Translate(node.Type)).AppendClosingPunctuation(")"),
        ...
        _ = section switch {
          NodeSection.Entry => output.AppendOpeningPunctuation("CAST("),
          NodeSection.Exit => output.Append("AS SIGNED ").Append(Translate(node.Type)).AppendClosingPunctuation(")"),
          _ => throw new ArgumentOutOfRangeException(nameof(section)),
        };
      }
    ...
    {
      switch (dateTimePart) {
        case SqlTimePart.Millisecond:
          _ = output.Append("MICROSECOND");
          break;
        case SqlTimePart.Hour:
          _ = output.Append("HOUR");
          break;
        case SqlTimePart.Minute:
          _ = output.Append("MINUTE");
          break;
        default:
          base.Translate(output, dateTimePart);
